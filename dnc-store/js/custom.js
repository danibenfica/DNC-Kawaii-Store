...
var currentSlide = 0;
var totalSlides = document.querySelectorAll('.img-box6 figure').length;
var prevButton = document.querySelector('.carousel-control-prev');
var nextButton = document.querySelector('.carousel-control-next');

function showSlide(index) {
   var slides = document.querySelectorAll('.img-box6 figure');
...
comprar.addEventListener('click', direcionaComprar)

function direcionaComprar() {
	window.location.href = 'buy.html'
}

var sobre = document.getElementById('sobreNos')

sobre.addEventListener('click', direcionaSobre)

function direcionaSobre() {
